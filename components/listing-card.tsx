...
export function ListingCard({
  ...
  return (
    <a
      ...
      className={cn(
        'group block overflow-hidden rounded-[1.25rem] sm:rounded-[1.75rem] border border-stone-light bg-white shadow-sm transition hover:-translate-y-1 hover:border-stone hover:shadow-soft',
...
/>
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="mt-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-t border-stone-light pt-4">
          ...
          <span
            className={cn(
              'w-full sm:w-auto text-center shrink-0 rounded-xl px-3 sm:px-4 py-2 text-sm font-medium transition',
              isClaimed
